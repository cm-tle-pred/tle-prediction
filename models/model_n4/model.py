...
class ResMultiNet28(nn.Module):
    def __init__(self, input_size, width):
        super(ResMultiNet28, self).__init__()

        # output fixed to 6
        self.model1 = ResNet28(input_size, 1, width)
        self.model2 = ResNet28(input_size, 1, width)
        self.model3 = ResNet28(input_size, 1, width)
        self.model4 = ResNet28(input_size, 1, width)
        self.model5 = ResNet28(input_size, 1, width)
        self.model6 = ResNet28(input_size, 1, width)
    ...
    def forward(self, x):
        ...
        return torch.cat((out1, out2, out3, out4, out5, out6),1)


class ResMultiNet30(nn.Module):
    def __init__(self, input_size, width):
        super(ResMultiNet30, self).__init__()

        # output fixed to 6
        output_size = int(width)
        linear_size = int(output_size*6)

        self.model1 = ResNet28(input_size, output_size, width)
        self.model2 = ResNet28(input_size, output_size, width)
        self.model3 = ResNet28(input_size, output_size, width)
        self.model4 = ResNet28(input_size, output_size, width)
        self.model5 = ResNet28(input_size, output_size, width)
        self.model6 = ResNet28(input_size, output_size, width)

        self.final = nn.Linear(linear_size, 6)
    ...
    def forward(self, x):
        ...
        final_input = torch.cat((out1,out2,out3,out4,out5,out6),1)
